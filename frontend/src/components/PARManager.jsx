        ...
        <div key={categoryName}>
          ...
          >
            <div className="flex items-center gap-2">
              <svg
                className={`w-3.5 h-3.5 text-[#8A9099] transition-transform ${expandedCategories[categoryName] !== false ? 'rotate-90' : ''}`}
          ...
          {expandedCategories[categoryName] !== false && categoryProducts.map((product) => {
